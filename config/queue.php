    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            ...
            'connection' => env('RABBITMQ_CONNECTION_CLASS'), // optional custom connection class
            'worker' => env('RABBITMQ_WORKER', 'default'), // set to 'horizon' if using Horizon
            ...
            'options' => [
                ...
                'queue' => [
                    ...
                    'failed_exchange' => env('RABBITMQ_FAILED_EXCHANGE', null),
                    'failed_routing_key' => env('RABBITMQ_FAILED_ROUTING_KEY', null),
                ],

<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <!-- فلتر نوع النشاط -->
            <div class="col-md-3">
                <label for="activityAction" class="form-label">نوع النشاط</label>
                <select class="form-select" 
                        wire:model.live="activityActionFilter"
                        wire:loading.attr="disabled"
                        wire:target="activityActionFilter">
            ...
            <!-- فلتر حالة النشاط -->
            <div class="col-md-3">
                <label for="activityStatus" class="form-label">حالة النشاط</label>
                <select class="form-select" 
                        wire:model.live="activityStatusFilter"
                        wire:loading.attr="disabled"
                        wire:target="activityStatusFilter">
        ...
        <!-- Loading State -->
        <div wire:loading wire:target="search,activityActionFilter,activityStatusFilter,dateFrom,dateTo" class="text-center mt-3">
